...
async def price_engine():
    while True:
        ...
        for asset in assets:
            ...
            elif asset["type"] == "Fixed Deposits":
                change = 0.0002
...
async def lifespan(app: FastAPI):
    ...
    {"name":"FD 3 Year","ticker":"FD3","price":100,"change":0,"risk":"Low","type":"Fixed Deposits"},
    {"name":"FD 5 Year","ticker":"FD5","price":100,"change":0,"risk":"Low","type":"Fixed Deposits"},
    {"name":"Senior Citizen FD","ticker":"SCFD","price":100,"change":0,"risk":"Low","type":"Fixed Deposits"},
])
